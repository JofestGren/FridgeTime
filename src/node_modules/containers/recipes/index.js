...
import {getRecipes, getRecipeInBasket, getErrorRecipes} from 'selectors'
      ...
      <div className='recipes-banner'>
        {
          ...
          <div className='recipes-error'>
            <div className='recipes-error__item'></div>
            <span className='recipes-error__desc'>Your enter parameters search not correct!</span>
          </div>
        }
        {
          !recipesError &&
...
const mapStateToProps = state => {
  ...
  recipesError: getErrorRecipes(state),
